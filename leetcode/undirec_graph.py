...
class Graph:
    ...
    def cycle_nodes(self):
        ...
        while True:
            ...
            if len(self.graph[s]) != 0:
                ss = s
                for __ in self.graph[s]:
                    if visited.count(__[1]) > 0 and __[1] != parent and indirect_parents.count(
                            __[1]) > 0 and not on_the_way_back:
                        l = len(stack) - 1
                        while True and l >= 0:
                            if stack[l] == __[1]:
    ...
    def all_nodes(self):
        ...
        return self.graph, list(self.graph)
